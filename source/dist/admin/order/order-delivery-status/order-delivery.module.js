...
exports.OrderDeliveryModule = void 0;
...
const order_delivery_controller_1 = require("./order-delivery.controller");
...
let OrderDeliveryModule = class OrderDeliveryModule {
};
OrderDeliveryModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [order_delivery_controller_1.OrderDeliveryController],
        providers: [order_delivery_service_1.OrderDeliveryService]
    })
], OrderDeliveryModule);
exports.OrderDeliveryModule = OrderDeliveryModule;
//# sourceMappingURL=order-delivery.module.js.map