...
const airport_repository_1 = require("../respository/airport.repository");
...
AirportService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(airport_repository_1.AirportRepository)),
    __metadata("design:paramtypes", [airport_repository_1.AirportRepository])
], AirportService);
